...
import SettingsPaymentGatewayAxone from '../../pages/Setting/Payment/SettingsPaymentGatewayAxone';
        ...
        <Card style={{ marginTop: '10px' }}>
          ...
          >
            ...
            >
              ...
              <Tabs.TabPane tab={t('AXOne 设置')} itemKey='axone'>
                <SettingsPaymentGatewayAxone
                  options={inputs}
                  refresh={onRefresh}
                  hideSectionTitle
                />
