...
export function RechargeFormCard({
  ...
  const [axoneDialogOpen, setAxoneDialogOpen] = useState(false)
  ...
  return (
    ...
    >
                  ...
                  <div className='space-y-3'>
                    ...
                    {topupInfo?.enable_axone_topup === true && (
                      <Button
                        ...
                        onClick={() => setAxoneDialogOpen(true)}
                      >
                        <Coins className='h-4 w-4' />
                        {t('Open Stablecoin Payment')}
                      </Button>
                    )}
                  </div>
      ...
      <Dialog open={axoneDialogOpen} onOpenChange={setAxoneDialogOpen}>
        <DialogContent className='max-sm:w-[calc(100vw-1.5rem)] sm:max-w-lg'>
          <DialogHeader>
            <DialogTitle>{t('Stablecoin Payment')}</DialogTitle>
            <DialogDescription>
              {t(
                'Choose a currency and chain, then generate the wallet address for your transfer.'
              )}
            </DialogDescription>
          </DialogHeader>
          <AxoneTopupSection
